...
print(응답객체)             # <http.client.HTTPResponse object at 0x000001C07D5CDD50>
...
response = urllib.request.urlopen(request)  # 4. urlopen 메소드를 이용한 url에 대한 요청을 실행하고 응답 객체를 반환 함수
print(response)     # <http.client.HTTPResponse object at 0x000001C07D5CDD50>
